...
namespace QLCF
{
    public partial class fTableManager : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(string.Format("Bạn có muốn chuyển bàn {0} qua bàn {1} không?", (lsvBill.Tag as Table).Name, (cbxSwitchTable.SelectedItem as Table).Name), "Thông báo", MessageBoxButtons.OKCancel) == System.Windows.Forms.DialogResult.OK)
            {
        ...
        {
            LoadFoodListByCategoryID((cbxCategory.SelectedItem as Category).ID);
            if(lsvBill.Tag != null)
